...
export const metadata: Metadata = {
  title: 'About',
  description: 'Raymond Shideler - Career history and professional background. Marketing & Sales professional, Entrepreneur, Composer, and founder of Soundcheck Live.',
  alternates: {
